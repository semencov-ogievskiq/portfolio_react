        ...
        886: function (module, exports, __webpack_require__) {
            ...
            for (
                ...
                if (!("labels" in convert[_model]))
                    throw new Error(
                        "missing channel labels property: " + _model
                    );
                if (convert[_model].labels.length !== convert[_model].channels)
                    throw new Error(
                        "channel and label counts mismatch: " + _model
                    );
                ...
                delete convert[_model].channels,
                    ...
                    Object.defineProperty(convert[_model], "labels", {
                        value: _labels,
                    });
            }
        ...
        941: function (module, __webpack_exports__, __webpack_require__) {
            ...
            function i(e) {
                ...
                return (
                    ...
                    Object(react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(
                        function (e) {
            ...
            var s,
                ...
                h = react__WEBPACK_IMPORTED_MODULE_0___default.a.memo(function (
                    r
                ) {
                    var t = r.onMove,
                        s = r.onKey,
                        f = u(r, ["onMove", "onKey"]),
                        h = Object(react__WEBPACK_IMPORTED_MODULE_0__.useRef)(
                            null
                        ),
                        m = Object(react__WEBPACK_IMPORTED_MODULE_0__.useRef)(
                            !1
                        ),
                        g = Object(react__WEBPACK_IMPORTED_MODULE_0__.useState)(
                            !1
                        ),
                        p = g[0],
                        b = g[1],
                ...
                z = react__WEBPACK_IMPORTED_MODULE_0___default.a.memo(function (
                    r
                ) {
                    var t = r.hue,
                        o = r.onChange,
                ...
                B = react__WEBPACK_IMPORTED_MODULE_0___default.a.memo(function (
                    r
                ) {
                    var t = r.hsva,
                        o = r.onChange,
            ...
            function D(e, r, l) {
                var u = i(l),
                    c = Object(react__WEBPACK_IMPORTED_MODULE_0__.useState)(
                        function () {
                            return e.toHsva(r);
                        }
                    ),
            ...
            var L,
                ...
                Y = {
                    ...
                    equal: function (e, r) {
                        return (
                            e.toLowerCase() === r.toLowerCase() || K(b(e), b(r))
                        );
                    },
                },
                $ = function (r) {
