    ...
    [0],
    {
        ...
        942: function (module, __webpack_exports__, __webpack_require__) {
                          ...
                          (function getContainingBlock(element) {
                              for (
                                  ...
                                  if (
                                      ...
                                      "paint" === css.contain ||
                                      ["transform", "perspective"].includes(
                                          css.willChange
                                      ) ||
                                      (isFirefox &&
                        ...
                        instance = {
                            ...
                            setOptions: function setOptions(options) {
                                ...
                                var orderedModifiers = (function orderModifiers(
                                    ...
                                    return enums.g.reduce(function (
                                        acc,
                                        phase
                                    ) {
                                        return acc.concat(
            ...
            function detectOverflow(state, options) {
                ...
                if (elementContext === enums.i && offsetData) {
                    ...
                    Object.keys(overflowOffsets).forEach(function (key) {
                        var multiply =
                                [enums.k, enums.c].indexOf(key) >= 0 ? 1 : -1,
                            axis =
            ...
            function isAnySideFullyClipped(overflow) {
                return [enums.m, enums.k, enums.c, enums.f].some(function (
                    side
                ) {
                            ...
                            fn: function arrow(_ref) {
                                ...
                                if (arrowElement && popperOffsets) {
                                    var paddingObject =
                                        ...
                                        minProp =
                                            "y" === axis ? enums.m : enums.f,
                                        maxProp =
                                            "y" === axis ? enums.c : enums.k,
                                        endDiff =
